...
export function Header() {
  ...
  return (
    ...
    <header className="sticky top-0 z-50 border-b border-neutral-200 bg-red-500 backdrop-blur-sm pt-[env(safe-area-inset-top)]">
      <Container>
        <nav className="flex items-center justify-between py-3 sm:py-6 bg-blue-500">
          {/* Logo/Brand */}
